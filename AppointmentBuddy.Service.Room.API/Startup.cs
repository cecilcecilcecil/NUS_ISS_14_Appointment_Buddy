...
using AppointmentBuddy.Service.Room.API.Infrastructure;
...
namespace AppointmentBuddy.Service.Room.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IRoomRepositoryService, RoomRepositoryService>();
        }
