...
using AppointmentBuddy.Service.PatientInfo.API.Infrastructure;
...
namespace AppointmentBuddy.Service.PatientInfo.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient<IPatientInfoService, PatientInfoService>();
            services.AddTransient<IPatientInfoRepositoryService, PatientInfoRepositoryService>();
        }
